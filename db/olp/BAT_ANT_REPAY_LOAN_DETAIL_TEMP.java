...
public class BAT_ANT_REPAY_LOAN_DETAIL_TEMP {
    ...
    public Short getCurrOvdPrinBal() {
        return currOvdPrinBal;
    }

    public void setCurrOvdPrinBal(Short currOvdPrinBal) {
    ...
    public Short getPaidOvdPrinAmt() {
        return paidOvdPrinAmt;
    }

    public void setPaidOvdPrinAmt(Short paidOvdPrinAmt) {
    ...
    public Short getPaidOvdIntAmt() {
        return paidOvdIntAmt;
    }

    public void setPaidOvdIntAmt(Short paidOvdIntAmt) {
    ...
    public Short getFeeAmt() {
        return feeAmt;
    }

    public void setFeeAmt(Short feeAmt) {
        this.feeAmt = feeAmt;
    }
