...
public class BAT_CRD_CONT_INFO {
    ...
    public void setCrdTerm(String crdTerm) {
        this.crdTerm = crdTerm == null ? null : crdTerm.trim();
    }

    public String getCrdStartDate() {
        return crdStartDate;
    }

    public void setCrdStartDate(String crdStartDate) {
        this.crdStartDate = crdStartDate == null ? null : crdStartDate.trim();
    }
    ...
    public void setCrdEndDate(String crdEndDate) {
        this.crdEndDate = crdEndDate == null ? null : crdEndDate.trim();
    }
    ...
    public String getSuspTag() {
        return suspTag;
    }

    public void setSuspTag(String suspTag) {
        this.suspTag = suspTag == null ? null : suspTag.trim();
    }
    ...
    public void setInvaildDate(String invaildDate) {
        this.invaildDate = invaildDate == null ? null : invaildDate.trim();
    }
