...
public class BAT_WHITE_LIST {
    ...
    public void setAgeOfEntry(String ageOfEntry) {
        this.ageOfEntry = ageOfEntry == null ? null : ageOfEntry.trim();
    }
    ...
    public String getBizFlg() {
        return bizFlg;
    }

    public void setBizFlg(String bizFlg) {
        this.bizFlg = bizFlg == null ? null : bizFlg.trim();
    }
