...
public class RAT_SECOND_APP_INFO {
    private String tpNo;
    ...
    private Integer platformAdmit;

    private BigDecimal platformRate;

    private String riskRating;

    private String solvencyRating;
    ...
    public void setPlatformAccess(String platformAccess) {
        this.platformAccess = platformAccess == null ? null : platformAccess.trim();
    }

    public Integer getPlatformAdmit() {
        return platformAdmit;
    }

    public void setPlatformAdmit(Integer platformAdmit) {
    ...
    public String getSolvencyRating() {
        return solvencyRating;
    }

    public void setSolvencyRating(String solvencyRating) {
        this.solvencyRating = solvencyRating == null ? null : solvencyRating.trim();
    }
