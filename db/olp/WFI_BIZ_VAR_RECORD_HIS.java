...
public class WFI_BIZ_VAR_RECORD_HIS {
    private String pk1;
    ...
    public void setVarDispvalue(String varDispvalue) {
        this.varDispvalue = varDispvalue == null ? null : varDispvalue.trim();
    }
    ...
    public void setVarOldValue(String varOldValue) {
        this.varOldValue = varOldValue == null ? null : varOldValue.trim();
    }
    ...
    public void setVarOldDispvalue(String varOldDispvalue) {
        this.varOldDispvalue = varOldDispvalue == null ? null : varOldDispvalue.trim();
    }
