...
public class WF_GATHER_RECORDEND {
    ...
    public void setBeforeinstanceid(String beforeinstanceid) {
        this.beforeinstanceid = beforeinstanceid == null ? null : beforeinstanceid.trim();
    }
    ...
    public void setGatherstartuserid(String gatherstartuserid) {
        this.gatherstartuserid = gatherstartuserid == null ? null : gatherstartuserid.trim();
    }
    ...
    public void setGatherstartusername(String gatherstartusername) {
        this.gatherstartusername = gatherstartusername == null ? null : gatherstartusername.trim();
    }
    ...
    public void setGatherenduserid(String gatherenduserid) {
        this.gatherenduserid = gatherenduserid == null ? null : gatherenduserid.trim();
    }
    ...
    public void setGatherendusername(String gatherendusername) {
        this.gatherendusername = gatherendusername == null ? null : gatherendusername.trim();
    }
    ...
    public void setGathertitle(String gathertitle) {
        this.gathertitle = gathertitle == null ? null : gathertitle.trim();
    }
    ...
    public void setAllprocessor(String allprocessor) {
        this.allprocessor = allprocessor == null ? null : allprocessor.trim();
    }
    ...
    public void setAllprocessorname(String allprocessorname) {
        this.allprocessorname = allprocessorname == null ? null : allprocessorname.trim();
    }
    ...
    public void setCurrentgatherprocessors(String currentgatherprocessors) {
        this.currentgatherprocessors = currentgatherprocessors == null ? null : currentgatherprocessors.trim();
    }
    ...
    public void setGatherstarttime(String gatherstarttime) {
        this.gatherstarttime = gatherstarttime == null ? null : gatherstarttime.trim();
    }
    ...
    public void setGatherendtime(String gatherendtime) {
        this.gatherendtime = gatherendtime == null ? null : gatherendtime.trim();
    }
}